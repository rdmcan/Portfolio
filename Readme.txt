...
Creating a Git Repository: git init (only once)

Staging: The staging area acts as a buffer zone where you can select 
the specific changes you want to include in your next commit. 
git add <filename>
git add .  (stage all the changes in your working directory)

Committing: A commit represents a snapshot of your project at a specific point in time. 
...
Merging branches: Once you've completed your work on a branch, you can merge it back into the main
branch (usually called master or main). First, switch to the main branch and then execute the 
following command:
